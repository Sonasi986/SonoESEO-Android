package fr.sonoeseo.sonoapp.controller.activities.meeting;
...
public class MeetingInformations extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View informationView = inflater.inflate(R.layout.layout_meeting, container, false);
        ...
        TextView txtPlace = informationView.findViewById(R.id.txtPlace);
        txtPlace.setText(getString(R.string.emptyField));
        if (Content.activity.getPlace() != null) {
            txtPlace.setText(ctx.getString(R.string.room) + " " + Content.activity.getPlace());
        }
        ...
        if (!Content.activity.getTeam().isEmpty()) {
            ...
            team.setLayoutManager(new LinearLayoutManager(ctx, LinearLayoutManager.HORIZONTAL,
                    false));
